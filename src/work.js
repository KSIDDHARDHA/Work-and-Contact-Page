...
<h1 className='text-8xl font-semibold mt-15 text-white p-9 m-7'>  OUR WORKS</h1>
...
<img src={Frame} className="logo cursor-pointer opacity-[0.5] hover:opacity-[1]" width={550} height={600}/>

<br/>
<p className='text-white text-xl cursor-pointer justify-center'> <b>01</b>.App for women's safety <br/>UI Design<br/> UX wireframe</p>
</div>
            </h3>
          </div>
          <div>
            <h3>
            <div className='flex flex-col gap-10 p-20 lg:flex-row '>
   <img src={Together} className="logo cursor-pointer opacity-[0.5] hover:opacity-[1] " width={550} height={600}/>

<br/>
<p className='text-white text-xl cursor-pointer'> <b>02</b>. website for women's safety <br/>UI Design <br/>UX wireframes</p>
